...
import "./Cars Max-width 600px.css";
import "./Cars Min-width 900px.css";
import { Link } from "react-router-dom";
import { handleChangeImgCarsWhenClickLogo } from "./handle Change img";
import { handlebtnArrowWhenClick } from "./handle btn arrow";
function Cars() {

  return (
    <div className="Cars">
      <div className="Cars__container layout">
        <div className="Cars__box--logo">
          <div className="Cars__box__logo--options">
            <div
              data-location="0"
              onClick={(e) => handleChangeImgCarsWhenClickLogo(e.target)}
              data-img={"./IMG Big cars/vf-5plus.png"}
              data-kind={"A-SUV"}
              data-seat={"5"}
              data-distance="471"
              data-price={"1.090.000.000"}
              className="Cars__box__logo__options--items Cars__box__logo__options__items--change-fill "
              current-item="0"
            >
              <svg
                width="128"
              ...
              >
                <g clipPath="url(#clip0_9060_7885)">
                ...
                <defs>
                  <clipPath id="clip0_9060_7885">
                    <rect width="127.333" height="24"></rect>
                  </clipPath>
                </defs>
              </svg>
            </div>
            <div
              onClick={(e) => handleChangeImgCarsWhenClickLogo(e.target)}
              data-img={"./IMG Big cars/vf-6.png"}
              data-kind={"B-SUV"}
              data-seat={"5"}
              data-distance="399"
              data-location="1"
              data-price={"675.000.000"}
              className="Cars__box__logo__options--items"
            >
              <svg
                width="92"
                height="31"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_8158_6100)">
            ...
            <div
              onClick={(e) => handleChangeImgCarsWhenClickLogo(e.target)}
              data-location="2"
              data-img={"./IMG Big cars/vf-e34.png"}
              data-kind={"C-SUV"}
              data-seat={"5-6"}
              data-distance="626"
              data-price={"1.491.000.000"}
              className="Cars__box__logo__options--items"
            >
              <svg
                width="123"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_7952_5899)"></g>
                <g clipPath="url(#clip1_7952_5899)">
            ...
            <div
              onClick={(e) => handleChangeImgCarsWhenClickLogo(e.target)}
              data-img={"./IMG Big cars/vf-7.png"}
              data-kind={"C-SUV"}
              data-location="3"
              data-seat={"5"}
              data-distance="431"
              data-price={"850.000.000"}
              className="Cars__box__logo__options--items"
            >
              <svg
                width="92"
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_8834_7504)">
            ...
            <div
              onClick={(e) => handleChangeImgCarsWhenClickLogo(e.target)}
              data-img={"./IMG Big cars/vf-8.png"}
              data-kind={"D-SUV"}
              data-seat={"4"}
              data-location="4"
              data-distance="471"
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_7952_5908)"></g>
                <g clipPath="url(#clip1_7952_5908)">
            ...
            <div
              onClick={(e) => handleChangeImgCarsWhenClickLogo(e.target)}
              data-img={"./IMG Big cars/vf-9.png"}
              data-kind={"E-SUV"}
              data-location="5"
              data-seat={"6-7"}
              data-distance="626"
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_7952_5911)"></g>
                <g clipPath="url(#clip1_7952_5911)">
          ...
          <div className="Cars__box__bar--down"></div>
        </div>
        <div className="Cars__box--items">
          <div className="Cars__box--items--img">
            <img className="Cars__box--img " src="./IMG Big cars/vf-5plus.png" alt="" />
            <div className="Cars__box__items--arow">
              <div
                className="Cars__box__items--arow__items"
                onClick={() => handlebtnArrowWhenClick("prev")}
              >
              ...
              <div
                className="Cars__box__items--arow__items"
                onClick={() => handlebtnArrowWhenClick("next")}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
        ...
        <div className="Cars__box__items--detail">
          <div className="Cars__box__items__detail--parameter">
            <div className="Cars__box__items__detail__parameter--kind">
              <div className="Cars__box__items__detail__parameter--title">
                Dòng xe
              </div>
              <div className="Cars__box__items__detail__parameter--value">
                A-SUV
              </div>
            </div>
            <div className="Cars__box__items__detail__parameter--seat">
              <div className="Cars__box__items__detail__parameter--title">
                Số chỗ ngồi
              </div>
              <div className="Cars__box__items__detail__parameter--value">
            ...
            <div className="Cars__box__items__detail__parameter--distance">
              <div className="Cars__box__items__detail__parameter--title">
                Quãng đường lên tới
              </div>
              <div className="Cars__box__items__detail__parameter--value">
            ...
            <div className="Cars__box__items__detail__parameter--price">
              <div className="Cars__box__items__detail__parameter--title">
                Giá từ
              </div>
              <div className="Cars__box__items__detail__parameter--value">
          ...
          <div className="Cars__box__items__detail--btn">
            <a
              href={"#Đặt cọc A-SUV"}
              className="Cars__box__items__detail__btn--deposit"
            >
              Đặt cọc
            </a>
            <a
              to={"#Xem chi tiết  A-SUV"}
              className="Cars__box__items__detail__btn--views-more"
            >
              Xem chi tiết
            </a>
          </div>
